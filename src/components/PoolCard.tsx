       ...
       <div className="absolute top-4 left-4">
        ...
        <div className="relative z-10 p-8">
          ...
          <div className="mb-6">
            ...
            <motion.div
              className="text-center my-6 p-6 rounded-2xl bg-gradient-to-r from-pink-500/20 to-fuchsia-500/20 border border-pink-500/30"
              whileHover={{ boxShadow: '0 0 30px rgba(236, 72, 153, 0.3)' }}
            >
          ...
          >
            {pool.isActive && (
              <>
                ...
                {/* Pulse effect */}
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-pink-500/30 to-fuchsia-500/30 rounded-2xl"
