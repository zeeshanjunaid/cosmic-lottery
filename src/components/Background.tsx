       ...
       <div className="absolute top-4 left-4">
        ...
        <div className="relative z-10 p-8">
          ...
          <div className="mb-6">
            ...
            <motion.div
              className="text-center my-6 p-6 rounded-2xl bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30"
              whileHover={{ boxShadow: '0 0 30px rgba(251, 191, 36, 0.3)' }}
            >
              ...
              <div className="text-yellow-400/70 text-sm">USDT</div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="text-center p-3 rounded-xl bg-white/5 border border-blue-500/20">
              ...
              <div className="text-blue-400 font-bold">${pool.ticketPrice}</div>
              <div className="text-gray-400 text-xs">per ticket</div>
            </div>
            
            <div className="text-center p-3 rounded-xl bg-white/5 border border-purple-500/20">
              <Users className="w-5 h-5 text-purple-400 mx-auto mb-1" />
              <div className="text-purple-400 font-bold">{pool.soldTickets}</div>
            ...
            <div className="text-center p-3 rounded-xl bg-white/5 border border-green-500/20">
              ...
              <div className="text-green-400 font-bold">{pool.maxTickets - pool.soldTickets}</div>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-blue-400 font-bold">{progressPercentage.toFixed(0)}%</span>
              </div>
            </div>
          ...
          >
            {pool.isActive && (
              <>
                ...
                {/* Pulse effect */}
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-blue-500/30 to-purple-500/30 rounded-2xl"
