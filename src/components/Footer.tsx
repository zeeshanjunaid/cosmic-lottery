        ...
        <div className="border-t border-white/10 py-4 sm:py-6 lg:py-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-400">
              <span className="px-2 py-1 bg-white/5 rounded whitespace-nowrap">Built on Ethereum</span>
              <span className="px-2 py-1 bg-white/5 rounded whitespace-nowrap">Provably Fair</span>
              <span className="px-2 py-1 bg-white/5 rounded whitespace-nowrap">Instant Payouts</span>
            </div>
          </div>
        </div>
      </div>
