...
const PoolCard: React.FC<PoolCardProps> = ({ pool }) => {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl bg-black/20 backdrop-blur-xl border border-red-500/20 shadow-2xl">
        ...
        <div className="relative z-10 p-6">
          ...
          <div className="mb-6">
            ...
            {/* Prize Pool */}
            <motion.div
              className="text-center p-4 rounded-xl bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-500/30"
              whileHover={{ boxShadow: '0 0 20px rgba(239, 68, 68, 0.3)' }}
            >
              <div className="text-red-400 text-sm font-medium mb-1">PRIZE POOL</div>
              <motion.div 
                className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-yellow-400"
                animate={isHovered ? { scale: [1, 1.05, 1] } : {}}
                transition={{ duration: 0.3 }}
              >
                ${pool.prizePool}
              </motion.div>
              <div className="text-red-400/70 text-sm">USDT</div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            <div className="text-center p-3 rounded-lg bg-white/5 border border-red-500/20">
              ...
              <div className="text-red-400 font-bold text-sm">${pool.ticketPrice}</div>
            ...
            <div className="text-center p-3 rounded-lg bg-white/5 border border-orange-500/20">
              ...
              <div className="text-orange-400 font-bold text-sm">{pool.soldTickets}</div>
              <div className="text-gray-400 text-xs">participants</div>
            </div>
            
            <div className="text-center p-3 rounded-lg bg-white/5 border border-yellow-500/20">
              <Ticket className="w-4 h-4 text-yellow-400 mx-auto mb-1" />
              <div className="text-yellow-400 font-bold text-sm">{pool.maxTickets - pool.soldTickets}</div>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-red-400 font-bold text-sm">{progressPercentage.toFixed(0)}%</span>
              </div>
            </div>
