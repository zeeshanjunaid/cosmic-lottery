    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
        <Card className="bg-[#181830]/60 backdrop-blur-xl border-white/10 text-center">
          <CardContent className="p-4 sm:p-6">
            <div className="p-3 bg-[#2DE582]/20 rounded-xl w-fit mx-auto mb-4">
              <DollarSign className="w-5 h-5 sm:w-6 sm:h-6 text-[#2DE582]" />
            </div>
            <div className="text-lg sm:text-2xl font-bold text-white mb-1">${totalPrizes.toLocaleString()}</div>
            <div className="text-sm sm:text-base text-gray-400">Total Prizes Won</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#181830]/60 backdrop-blur-xl border-white/10 text-center">
          <CardContent className="p-4 sm:p-6">
            <div className="p-3 bg-[#2DE582]/20 rounded-xl w-fit mx-auto mb-4">
              <Crown className="w-5 h-5 sm:w-6 sm:h-6 text-[#2DE582]" />
            </div>
            <div className="text-lg sm:text-2xl font-bold text-white mb-1">{mockWinners.length}</div>
            <div className="text-sm sm:text-base text-gray-400">Total Winners</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#181830]/60 backdrop-blur-xl border-white/10 text-center">
          <CardContent className="p-4 sm:p-6">
            <div className="p-3 bg-[#2DE582]/20 rounded-xl w-fit mx-auto mb-4">
              <Star className="w-5 h-5 sm:w-6 sm:h-6 text-[#2DE582]" />
            </div>
            <div className="text-lg sm:text-2xl font-bold text-white mb-1">{recentWinners.length}</div>
            <div className="text-sm sm:text-base text-gray-400">Recent Winners</div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="space-y-4">
        <h2 className="text-xl sm:text-2xl font-bold text-white px-4 sm:px-0">Winner History</h2>
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
                <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                  {winner.isRecent && (
                    <Badge className="bg-[#2DE582]/20 border-[#2DE582]/30 text-[#2DE582] hover:bg-[#2DE582]/30 w-fit">
                      <motion.div
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-bold text-white">{winner.poolName}</h3>
                    <div className="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-4 text-xs sm:text-sm text-gray-400">
                      <div className="flex items-center space-x-1 break-all">
                        ...
                        <span className="font-mono text-xs sm:text-sm break-all">{formatAddress(winner.winner)}</span>
                      </div>
                      <div className="flex items-center space-x-1">
                        <Calendar className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                        <span className="text-xs sm:text-sm">{formatDate(winner.date)}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-left sm:text-right space-y-1 sm:space-y-2">
                  <div className="text-xl sm:text-2xl font-bold text-[#2DE582]">${winner.prizeAmount}</div>
